...
<body>
	<div class="container theme-showcase" role="main">
			...
			<div class="container-fluid" id="navfluid">
			  ...
			  <div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="active"><a href="login_t.php">Login Personale</a></li>
				</ul>
			  </div><!--/.nav-collapse -->
			</div>
		</nav>
		...
		<form id="login" class="form-signin" action="includes/authentication_t.php" method="post">
			<h2 class="form-signin-heading">Login Personale</h2>
