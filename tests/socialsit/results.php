<?php
	...
	$_SESSION['socialsit_a']['25']['1']=$_POST['q25_1'];
	if(isset($_POST['q25_2'])) {
		$_SESSION['socialsit_a']['25']['2']=$_POST['q25_2'];
	}
	if(isset($_POST['q25_3'])) {
		$_SESSION['socialsit_a']['25']['3']=$_POST['q25_3'];
	}
...
<html>
	...
	<body>
		...
		?>
			...
			<div class="page-header row socialsitresults">
		<?php
			$results = '';
			foreach ($_SESSION['socialsit_a'] as $dom) {
				foreach ($dom as $subdom) {
					$results=$results.$subdom.',';
				}
			}
			$results=rtrim($results, ",");

			$stmt = $mysqli->prepare('call socialsit_insert(?,?,?,?,@e)');
			$stmt->bind_param('siii', $results, $_SESSION['user']['id'], $_SESSION['socialsit']['qtype'], $_SESSION['socialsit']['atype']);
		...
		<?php
			...
			$_SESSION['socialsit_a']=array();
			unset($_SESSION['socialsit']);
			unset($_SESSION['qe_a']);
