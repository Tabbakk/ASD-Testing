...
<html>
	...
	<body>
		...
		?>
			...
			<div class="page-header row qeresults">
		<?php
			$results = '';
			foreach ($_SESSION['qe_a'] as $risposta) {
				$results=$results.$risposta.',';
			}
			$results=rtrim($results, ",");

			$stmt = $mysqli->prepare('call qe_insert(?,?,?,?,@e)');
			$stmt->bind_param('siii', $results, $_SESSION['user']['id'], $_SESSION['qe']['qtype'], $_SESSION['qe']['atype']);
