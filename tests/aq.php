	...
	<body>
		...
		?>
			...
			<div class="page-header testpagetitle">
				<h2>Quoziente di spettro autistico</h2>
				<?php
					if(isset($_SESSION['testflag']['aq'])){
				?>
			...
			<div class="container col-sm-6 col-sm-offset-3 testhelp">
				<?php
					if(isset($_SESSION['help']['aq'])){
						echo($_SESSION['help']['aq']);
					}
				?>
			</div>
			<div class="col-sm-4 col-sm-offset-4" id="inizio_test">
				<button class="btn btn-lg btn-default btn-block" onclick="window.location.href = 'aq/test.php?p=1'">Inizia il Test</button>
			</div>
		</div>
