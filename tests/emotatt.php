<?php
	...
	include '../includes/emotatt_init.php';

	$_SESSION['emotatt_a'] = array();
	unset($_SESSION['emotatt_a']);
	...
	<body>
		...
		?>
			...
			<div class="page-header testpagetitle">
				<h2>Test di attribuzione delle emozioni</h2>
				<?php
					if(isset($_SESSION['testflag']['emotatt'])){
				?>
			...
			<div class="container col-sm-6 col-sm-offset-3 testhelp">
				<?php
					if(isset($_SESSION['help']['emotatt'])){
						echo($_SESSION['help']['emotatt']);
					}
				?>
			</div>
			<div class="col-sm-4 col-sm-offset-4" id="inizio_test">
				<button class="btn btn-lg btn-default btn-block" onclick="window.location.href = 'emotatt/test.php?p=1'">Inizia il Test</button>
			</div>
		</div>
