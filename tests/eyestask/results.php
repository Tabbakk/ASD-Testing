<?php
	...
	$_SESSION['eyestask_a']['37']=$_POST['q37'];
...
<html>
	...
	<body>
		...
		?>
			...
			<div class="page-header row eyestaskresults">
			
			
		<?php
			$results = '';
			foreach ($_SESSION['eyestask_a'] as $risposta) {
				$results=$results.$risposta.',';
			}
			$results=rtrim($results, ",");

			$stmt = $mysqli->prepare('call eyestask_insert(?,?,?,?,@e)');
			$stmt->bind_param('siii', $results, $_SESSION['user']['id'], $_SESSION['eyestask']['qtype'], $_SESSION['eyestask']['atype']);
		...
		<?php
			...
			$_SESSION['eyestask_a'] = array();
			unset($_SESSION['eyestask']);
			unset($_SESSION['eyestask_a']);
