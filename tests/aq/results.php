...
<html>
	...
	<body>
		...
		?>
			...
			<div class="page-header row aqresults">			
		<?php
			$results = '';
			foreach ($_SESSION['aq_a'] as $risposta) {
				$results=$results.$risposta.',';
			}
			$results=rtrim($results, ",");

			$stmt = $mysqli->prepare('call aq_insert(?,?,?,?,@e)');
			$stmt->bind_param('siii', $results, $_SESSION['user']['id'], $_SESSION['aq']['qtype'], $_SESSION['aq']['atype']);
