<?php
	...
	$back='sA1bO2_test.php?p='.($num-1);
	
	$_SESSION['attint']['series'] = 2; 				//test series
			...
			<div class="page-header attinttest">
				...
				<div class="question row">
					<div class="col-sm-4 qimg">
						<img class="img-responsive" src="<?php echo($path.$_SESSION['attint']['2']["'".$num."'"]['A'].$extension)?>" alt="Prima Immagine">
					</div>
					<div class="col-sm-4 qimg">
						<img class="img-responsive" src="<?php echo($path.$_SESSION['attint']['2']["'".$num."'"]['B'].$extension)?>" alt="Seconda Immagine">
					</div>
					<div class="col-sm-4 qimg">
						<img class="img-responsive" src="<?php echo($path.$_SESSION['attint']['2']["'".$num."'"]['C'].$extension)?>" alt="Terza Immagine">
					</div>
				</div>
			</div>
