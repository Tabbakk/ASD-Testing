<?php
	...
	include '../includes/eyestask_init.php';
	...
	<body>
		...
		?>
			...
			<div class="page-header testpagetitle">
				<h2>Eyes Task</h2>
				<?php
					if(isset($_SESSION['testflag']['eyestask'])){
				?>
			...
			<div class="container col-sm-6 col-sm-offset-3 testhelp">
				<?php
					if(isset($_SESSION['help']['eyestask'])){
						echo($_SESSION['help']['eyestask']);
					}
				?>
			</div>
			<div class="col-sm-4 col-sm-offset-4" id="inizio_test">
				<button class="btn btn-lg btn-default btn-block" onclick="window.location.href = 'eyestask/test.php?p=1'">Inizia il Test</button>
			</div>
		</div>
