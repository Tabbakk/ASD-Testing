<?php
	...
	include '../includes/socialsit_init.php';

	$_SESSION['socialsit_a'] = array();
	unset($_SESSION['socialsit_a']);
	...
	<body>
		...
		?>
			...
			<div class="page-header testpagetitle">
				<h2>Test delle situazioni sociali</h2>
				<?php
					if(isset($_SESSION['testflag']['socialsit'])){
				?>
			...
			<div class="container col-sm-6 col-sm-offset-3 testhelp">
				<?php
					if(isset($_SESSION['help']['socialsit'])){
						echo($_SESSION['help']['socialsit']);
					}
				?>
			</div>
			<div class="col-sm-4 col-sm-offset-4" id="inizio_test">
				<button class="btn btn-lg btn-default btn-block" onclick="window.location.href = 'socialsit/test.php?p=1'">Inizia il Test</button>
			</div>
		</div>
