	...
	<body>
		...
		?>
			...
			<div class="page-header testpagetitle">
				<h2>Basic Empathy Task</h2>
				<?php
					if(isset($_SESSION['testflag']['bes'])){
				?>
			...
			<div class="container col-sm-6 col-sm-offset-3 testhelp">
				<?php
					if(isset($_SESSION['help']['bes'])){
						echo($_SESSION['help']['bes']);
					}
				?>
			</div>
			<div class="col-sm-4 col-sm-offset-4" id="inizio_test">
				<button class="btn btn-lg btn-default btn-block" onclick="window.location.href = 'bes/test.php?p=1'">Inizia il Test</button>
			</div>
		</div>
